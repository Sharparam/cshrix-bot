...
git clone -q -b gh-pages --depth 1 -- https://github.com/Sharparam/cshrix-bot.git gh-pages
...
Copy-Item .\docs\_site .\gh-pages\${target} -Recurse
Write-Host 'Copying new coverage'
Copy-Item .\artifacts\coverage-report .\gh-pages\${covtarget} -Recurse
